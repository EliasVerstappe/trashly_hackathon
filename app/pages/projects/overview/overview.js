...
exports.onLoaded = function(args) {
  ...
  httpModule.request({
    url: "http://172.20.3.42:3000/projects.json",
    method: "GET",
...
exports.navigateToCreate = function(args) {
  frameModule.topmost().navigate({moduleName: "pages/projects/create/create"});
};

exports.navigateToTasks = function(args) {
  frameModule.topmost().navigate({moduleName: "pages/task/overview/overview"});
};